                ...
                {this.state.isLoadingProducts ? (
                    ...
                    <div className="product">
                        ...
                        <div className="product__content">
                                                ...
                                                {attribute.type === "swatch"
                                                    ? attribute.items.map((item, index) => (
                                                        <li
                                                            ...
                                                            key={index}
                                                            className={`attribute__item--color ${this.searchCurrentAttributeValue(attribute.id, item.id) && "attribute__item--color--active"
                                                                }`}
                                                    ...
                                                    : attribute.items.map((item, index) => (
                                                        <li
                                                            onClick={() => this.onSetPickedAttributes({ attributeId: attribute.id, attributeValue: item.id })}
                                                            key={index}
                                                            className={`attribute__item ${this.searchCurrentAttributeValue(attribute.id, item.id) && "attribute__item--active"
                                                                }`}
                                                        >
                                                            {item.value}
                                                        </li>
                            ...
                            {productInStock ? (
                                <div className="product__btn" onClick={() => this.onAddToBasket()}>Add to cart</div>
                            ) : (
